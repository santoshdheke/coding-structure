                    ...
                    <form action="{{ route(AppHelper::getBaseRoute('store')) }}" class="form-horizontal form-label-left"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="currency_name" class="form-control col-md-7 col-xs-12"
                                       ...
                                       data-validate-words="2" name="currency_name" value="{{ old('currency_name') }}"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="symbol_area" class="form-control" id="">
                                    ...
                                    <option {{ (old('symbol_area') == 'front')?'selected':'' }} value="front">Front Symbol</option>
                                    <option {{ (old('symbol_area') == 'back')?'selected':'' }} value="back">Back Symbol</option>
                                </select>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="symbol" class="form-control col-md-7 col-xs-12"
                                       data-validate-length-range="6"
                                       data-validate-words="2" name="symbol" value="{{ old('symbol') }}"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="compare_with_dolor" class="form-control col-md-7 col-xs-12"
                                       data-validate-length-range="6"
                                       data-validate-words="2" name="compare_with_dolor" value="{{ old('compare_with_dolor') }}"
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <button type="reset" id="reset" class="btn btn-dark"> <i class="fa fa-refresh"></i> Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
