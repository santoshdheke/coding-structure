            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="{{ route(AppHelper::getBaseRoute('store')) }}" class="form-horizontal form-label-left"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="product_name" class="form-control col-md-7 col-xs-12"
                                       ...
                                       data-validate-words="2" name="product_name" value="{{ old('product_name') }}"
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="brand_id"> Brand <span
                                    class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="brand_id" class="form-control" id="brand_id">
                                    @if(isset($brands) && count($brands)>0)
                                        ...
                                        @endforeach
                                    @else
                                        <option value="" selected disabled>No Brand</option>
                                    @endif
                                </select>
                                @if($errors->has('brand_id'))
                                    <p class="text text-danger">{{ $errors->first('brand_id') }}</p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12"> Stander Price <span
                                    class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" name="price" placeholder="Enter Stander Price" class="form-control">
                            </div>
                        </div>

                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12"> Whole Sale Price </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <table class="table">
                                    <thead>
                                    <tr>
                                        <th>Out Of Quntaty</th>
                                        <th>Price
                                            <button id="plus_price_input" type="button" class="btn btn-xs btn-default pull-right"><i class="fa fa-plus"></i></button>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody id="table_body">
                                    <tr>
                                        <td><input type="number" name="minimum_qty[]" placeholder="Minimum Quntatity"></td>
                                        <td><input type="number" name="wholesale_price[]" placeholder="Price"></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div id="common-gallery-image" style="margin-top: 20px;" class="row"></div>
                            </div>
                        </div>
...
@push('js')
    <script>
        ...
        $('#plus_price_input').click(function () {
            var html = `<tr>
                                        <td><input type="number" name="minimum_qty[]" placeholder="Minimum Quntatity"></td>
                                        <td><input type="number" placeholder="Price">
                                            <button type="button" name="wholesale_price[]" class="btn btn-xs btn-dark pull-right minus_price_input"><i class="fa fa-minus"></i></button>
                                        </td>
                                    </tr>`;
            $('#table_body').append(html);
        });

        $(document).on('click','.minus_price_input',function () {
