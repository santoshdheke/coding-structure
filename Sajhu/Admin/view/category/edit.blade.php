    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="{{ route(AppHelper::getBaseRoute('update'),$category->id) }}"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="category_title" class="form-control col-md-7 col-xs-12"
                                       ...
                                       value="{{ old('category_title')?old('category_title'):$category->category_title }}"
                                        ...
                                        @foreach($attributes as $attribute)
                                            <div class="row">
                                                <input name="attribute_ids[]" value="{{ $attribute->id }}"
                                                       type="checkbox"
                                                       {{ (in_array($attribute->id,$category->attribute_ids))?'checked':'' }}
