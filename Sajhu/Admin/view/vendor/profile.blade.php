...
@section('content')
    ...
    <div class="page-title">
        <div class="title_left">
            <h3>{{ AppHelper::getTitle() }} Profile</h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>{{ AppHelper::getTitle() }} Detail <small>Activity report</small></h2>
                ...
                <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                        <div class="profile_img">
                            <div id="crop-avatar">
                                <!-- Current avatar -->
                                <img class="img-responsive avatar-view" src="{{ asset('admin/src/images/user.png') }}" alt="Avatar" title="Change the avatar">
                            </div>
                        </div>
                        <h3>Samuel Doe</h3>
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                    ...
                                    <ul class="messages">
                                        <li>
                                            <img src="{{ asset('admin/src/images/user.png') }}" class="avatar" alt="Avatar">
