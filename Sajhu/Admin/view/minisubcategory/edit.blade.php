            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li class="dropdown">
                            <a href="{{ route(AppHelper::getBaseRoute('index'),$subcategory) }}"
                ...
                <div class="x_content">
                    <form action="{{ route(AppHelper::getBaseRoute('update'),['subcategory' => $subcategory,'minisubcategory' => $minisubcategory->id]) }}"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="category_title" class="form-control col-md-7 col-xs-12"
                                       ...
                                       value="{{ old('category_title')?old('category_title'):$minisubcategory->category_title }}"
                                    ...
                                    @foreach($attributes as $attribute)
                                        <div class="row">
                                            <input name="attribute_ids[]" value="{{ $attribute->id }}"
                                                   type="checkbox"
                                                   {{ (in_array($attribute->id,$minisubcategory->attribute_ids))?'checked':'' }}
