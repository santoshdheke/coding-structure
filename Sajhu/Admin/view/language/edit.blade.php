    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="{{ route(AppHelper::getBaseRoute('update'),$language->id) }}"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="country_name" class="form-control col-md-7 col-xs-12"
                                       ...
                                       data-validate-words="2" name="country_name" value="{{ old('country_name')?old('country_name'):$language->country_name }}"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="country_code" class="form-control col-md-7 col-xs-12"
                                       data-validate-length-range="6"
                                       data-validate-words="2" name="country_code" value="{{ old('country_code')?old('country_code'):$language->country_code }}"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <label for="flag">
                                    <img id="upload_profile_picture" src="{{ asset(AppHelper::getFolderPath('thumbnails/35_35/'.$language->flag)) }}"
